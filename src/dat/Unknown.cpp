...
//------------------------------------------------------------------------------
Unknown2ndBlock::Unknown2ndBlock() : Unknown3(UNKNOWN3_LEN), Unknown4(UNKNOWN4_LEN)
{
  Pointer1 = 0;
  Pointer2 = 0;
  Pointer3 = 0;
...
{
  serialize<int32_t>(Unknown3, UNKNOWN3_LEN);
  ...
  serialize<int32_t>(Unknown4, UNKNOWN4_LEN);
}

//------------------------------------------------------------------------------
FirstSubData::FirstSubData() : Unknown5(UNKNOWN5_LEN)
{
}
...
{
  serialize<int32_t>(Unknown5, UNKNOWN5_LEN);
}

//------------------------------------------------------------------------------
SecondSubData::SecondSubData() : Unknown6(UNKNOWN6_LEN)
{
}
...
{
  serialize<int32_t>(Unknown6, UNKNOWN6_LEN);
}

//------------------------------------------------------------------------------
ThirdSubData::ThirdSubData() : Unknown7(UNKNOWN7_LEN)
{
}
...
{
  serialize<int32_t>(Unknown7, UNKNOWN7_LEN);
}
