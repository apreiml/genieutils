...
void DatFile::serializeObject(void )
{
  ...
  // This data seems to be needed only in the original Age of Empires.
  // In Rise of Rome and later games, this data is removable.
  // This data can be added in Star Wars games too.
